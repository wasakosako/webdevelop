        ...
        <Center h="100vh" >
            <form onSubmit={onsubmit}>
                <Stack align="flex-start" maxW="lg">
                    <InputField errors={errors} register={register} label="ユーザー名" required="ユーザー名は必須です" placeholder="Enter your username" registedname="username" />
                    <InputField errors={errors} register={register} label="メールアドレス" required="※メールアドレスは必須です" registedname="email"
